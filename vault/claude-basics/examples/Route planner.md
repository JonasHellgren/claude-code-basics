...
A traveler wants to visit five cities, each represented by an (x, y) coordinate. The goal is to find a short route that visits every city exactly once. It is one of many [[Examples]].
This simplified Traveling Salesman Problem is solved by three Claude subagents that create, evaluate, and improve the route.
