...
The **Hello World** example uses only the main agent. It receives the user prompt and responds with the fixed phrase `Hello World`, without using subagents, files, tools, or any more advanced workflow.
